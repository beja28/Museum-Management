...
public class AltaObra extends JFrame {
	...
	private ImageIcon iconVolver, iconAceptar, iconCancelar;
	private Image imgVolver, imgAceptar, imgcancelar;

	public AltaObra(Controller ctrl, MainRestauracion main) {
		this.main = main;
    	this.ctrl = ctrl;
        initComponents();
    }
    ...
    private void initComponents() {
    	...
    	JPanel panelAlta = new JPanel(new BorderLayout());
         ...
         mensaje.setText("Introduzca los datos de la obra que desea dar de alta en el sistema");
 		...
 		ok.addActionListener((e) -> {
 			...
 			if(ctrl.altaObra(data)) {
 				JOptionPane.showMessageDialog(null, "La obra se ha añadido correctamente");
 				main.volver();
 	          	this.dispose();
 			}
